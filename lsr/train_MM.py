...
configs_path=r'/home/heruhan/gnq/paper_codes/DeFNet/lsr'

vae_config_file = os.path.join(configs_path, 'configs', args_opt.exp_vae + '.py')
# vae_directory = os.path.join('.', 'models', args_opt.exp_vae)
vae_directory = os.path.join('.', 'lsr/models_ld=16_all_action_step4_20221108', args_opt.exp_vae)
