...
class LSRV2:
    ...
    directed_graph = False,  a_lambda_format='stacking', verbose = False,lower_b=0,upper_b=3):
        ...
        self.lower_b = lower_b   #  0
        self.upper_b = upper_b   #  3
    ...
    def optimize_lsr(self):
        res_opt = minimize_scalar(self.f_lsr, bounds=(self.lower_b ,self.upper_b ), method='bounded')  # find the minimize value
    ...
    def lsr_phase_1(self, latent_map, directed_graph):
        ...
        for latent_pair in latent_map:
            ...
            if action==1:
                ...
                Z_all.add(c_idx)
                G1.add_edge(c_idx-1,c_idx,l=np.round(dis,1),a_lambda=a_lambda)   #create the connection
